...
namespace Gameboy.VM.CPU
{
    internal class CPU : IEnumerable<int>
    {
        ...
        {
            // First check for and handle any interrupts
            ...
            if (_isHalted || _isStopped || _device.DMAController.HaltCpu())
            {
                yield return 1;
            }
            ...
            switch (opcode)
            {
                ...
                case 0x02:
                    ...
                    break;
                case 0x03:
                    _alu.Increment(Register16Bit.BC);
                ...
                case 0x0B:
                    _alu.Decrement(Register16Bit.BC);
                    break;
                case 0x0C:
                ...
                case 0x12:
                    ...
                    break;
                case 0x13:
                    _alu.Increment(Register16Bit.DE);
                    yield return 1;
                    break;
                case 0x14:
                ...
                case 0x1B:
                    _alu.Decrement(Register16Bit.DE);
                    yield return 1;
                    break;
                case 0x1C:
                ...
                case 0x23:
                    yield return 1;
                    _alu.Increment(Register16Bit.HL);
                    break;
                case 0x24:
                ...
                case 0x2B:
                    yield return 1;
                    _alu.Decrement(Register16Bit.HL);
                    break;
                case 0x2C:
                ...
                case 0x33:
                    yield return 1;
                    _alu.Increment(Register16Bit.SP);
                    break;
                case 0x34:
                    {
                ...
                case 0x3B:
                    yield return 1;
                    _alu.Decrement(Register16Bit.SP);
                    break;
                case 0x3C:
