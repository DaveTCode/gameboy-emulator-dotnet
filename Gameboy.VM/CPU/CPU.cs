    ...
    internal class CPU
    {
        ...
        internal int Step()
        {
            ...
            return opcode switch
            {
                ...
                0x2E => (_alu.Load(ref Registers.L, FetchByte()) + 1), // LD L, d8
                0x2F => _alu.CPL(), // CPL
                ...
                0x3E => (_alu.Load(ref Registers.A, FetchByte()) + 1), // LD A, d8
                0x3F => _alu.CCF(), // CCF
                0x40 => 1, // LD B, B
                ...
                0xC6 => _alu.Add(ref Registers.A, FetchByte(), false) + 1, // ADD A, d8
                ...
                0xCB => ProcessOpcodeCB() + 1, // CB prefixed opcodes (add one for retrieving CB opcode)
                0xCC => _alu.CallOnFlag(CpuFlags.ZeroFlag, FetchWord(), true), // CALL Z, a16
                0xCD => _alu.Call(FetchWord()), // CALL a16
                0xCE => _alu.Add(ref Registers.A, FetchByte(), true) + 1, // ADC A, d8
