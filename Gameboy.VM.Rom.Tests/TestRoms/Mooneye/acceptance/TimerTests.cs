...
namespace Gameboy.VM.Rom.Tests.TestRoms.Mooneye.acceptance
{
    public class TimerTests
    {
        ...
        [Theory]
        [InlineData("div_write.gb", 10 * 1000, 0x486E, "framebuffer")]
        //[InlineData("rapid_toggle.gb", 10 * 1000, 0x4B2E, "rapid_toggle_framebuffer")]
        [InlineData("tim00.gb", 10 * 1000, 0x4B2E, "tim00_framebuffer")]
        [InlineData("tim01.gb", 10 * 1000, 0x4B2E, "tim01_framebuffer")]
        [InlineData("tim10.gb", 10 * 1000, 0x4B2E, "tim10_framebuffer")]
        [InlineData("tim11.gb", 10 * 1000, 0x4B2E, "tim11_framebuffer")]
        ...
        [InlineData("tima_reload.gb", 10 * 1000, 0x4B2E, "tima_reload_framebuffer")]
