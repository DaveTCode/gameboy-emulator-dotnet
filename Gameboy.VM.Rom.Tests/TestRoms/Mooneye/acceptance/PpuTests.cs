...
namespace Gameboy.VM.Rom.Tests.TestRoms.Mooneye.acceptance
{
    public class PpuTests
    {
        ...
        //[InlineData("intr_2_0_timing.gb", 10 * 1000, 0x4B2E, "framebuffer")]
        [InlineData("intr_2_mode0_timing.gb", 10 * 1000, 0x4B2E, "intr_2_mode0_timing_framebuffer")]
        //[InlineData("intr_2_mode0_timing_sprites.gb", 10 * 1000, 0x4B2E, "framebuffer")]
        [InlineData("intr_2_mode3_timing.gb", 10 * 1000, 0x4B2E, "intr_2_mode3_timing_framebuffer")]
        [InlineData("intr_2_oam_ok_timing.gb", 10 * 1000, 0x4B2E, "intr_2_oam_ok_timing_framebuffer")]
