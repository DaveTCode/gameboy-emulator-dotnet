...
namespace Gameboy.Headless.Console
{
    ...
    internal class Program
    {
        ...
        {
            var device = new Device(CartridgeFactory.CreateCartridge(File.ReadAllBytes(options.RomFilePath)), options.Mode, new NullRenderer(options.Mode), new NullSoundOutput());
